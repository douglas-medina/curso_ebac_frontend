...
describe("Teste para a home", () => {
  ...
  it("Deve incluir informações no formulário", () => {
    cy.get('input[type="text"]').type("Douglas Medina"); // Preencher o campo de nome
    cy.get('input[type="email"]').type("douglas.medina@ebac.example.com"); // Preencher o campo de e-mail
    cy.get('input[type="tel"]').type("31912345678"); // Preencher o campo de telefone
  ...
  it("Deve alterar a informação da lista", () => {
    ...
    cy.get('input[type="text"]').clear().type("Daniel Santos"); // Limpar e preencher o campo de nome
    cy.get('input[type="email"]').clear().type("drsantos20@ebac.com.br"); // Limpar e Preencher o campo de e-mail
    cy.get('input[type="tel"]').clear().type("31912345678"); // Limpar e Preencher o campo de telefone
